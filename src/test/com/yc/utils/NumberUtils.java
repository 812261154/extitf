...
public class NumberUtils {
	...
	public static boolean isNumber(Object obj) {
		...
		if (clz == Integer.class || clz == Long.class || clz == Short.class || clz == Byte.class || clz == Float.class
				|| clz == Double.class || clz == BigDecimal.class || clz == BigInteger.class || clz == UFDouble.class) {
